...
int main(int argc, char* argv[])
{
    ...
    for(int i = result.size()-1; i >= 0; i--)
    {
        ...
        else if(result[i].substr(0,5) == "inser" || result[i].substr(0,5) == " inse"){
            avl.insertHelper(avl.getInsert(result[i]));
        }
        else if(result[i].substr(0,5) == "range" || result[i].substr(0,5) == " rang"){
            avl.rangeSearchHelper(avl.getRange(result[i]), avl.getRange2(result[i]));
        }
        else if(result[i].substr(0,5) == "print" || result[i].substr(0,5) == " prin"){
            avl.print();
        }
        else if(result[i].substr(0,5) == "heigh" || result[i].substr(0,5) == " heig"){
            avl.printHeight();
        }
